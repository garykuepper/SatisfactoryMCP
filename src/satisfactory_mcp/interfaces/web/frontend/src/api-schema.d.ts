...
export interface paths {
    ...
    "/api/maptiles/{layer}/{z}/{x}/{y}": {
         ...
         */
        get: operations["maptiles_layer_api_maptiles__layer___z___x___y__head"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
         ...
         *     deserves to be told which names exist rather than which types were expected.
         */
        head: operations["maptiles_layer_api_maptiles__layer___z___x___y__head"];
        patch?: never;
        trace?: never;
    };
    "/api/machines": {
...
export interface operations {
    ...
    maptiles_layer_api_maptiles__layer___z___x___y__head: {
        parameters: {
            query?: never;
            header?: never;
            path: {
